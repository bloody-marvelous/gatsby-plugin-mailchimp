...
var subscribeEmailToMailchimp = function subscribeEmailToMailchimp(url) {
  return new Promise(function(resolve, reject) {
    ...
    return (0,
    _jsonp2.default)(url, { param: "c", timeout: 3500 }, function(err, data) {
      if (err) reject(err);
...
var generateJSONPEndpoint = function generateJSONPEndpoint(str) {
  return str.replace(/\/post/g, "/post-json");
};
/*
...
var addToMailchimp = function addToMailchimp(
  email,
  fields,
  overridableEndpoint
) {
  ...
  var endpoint = overridableEndpoint
